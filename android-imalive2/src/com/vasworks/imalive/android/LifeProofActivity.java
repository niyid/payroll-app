...
public final class LifeProofActivity extends AppCompatActivity implements SensorEventListener, PhotoUploader {
	...
	private class GraphicFaceTracker extends Tracker<Face> {
		...
		public void onUpdate(FaceDetector.Detections<Face> detectionResults, Face face) {
			...
			boolean passed = mFaceGraphic.passed();
			...
			if (steady && passed) {
				...
				Log.i(LOG_TAG, "rating=" + rating + " bounds[0]=" + bounds[0] + " bounds[1]=" + bounds[1]);
	...
	private class UpdateStatusButtonColor implements Runnable {
		...
		public UpdateStatusButtonColor(LifeDetector mFaceGraphic, Button button, Double rating, Integer mode) {
			super();
		...
		protected String doInBackground(Void... params) {
			...
			try {
				...
				Object val = models.call("execute_kw", MainActivity.db, MainActivity.userId, MainActivity.password, "hr.employee",
						"activate_payment", methodParams.toArray());
