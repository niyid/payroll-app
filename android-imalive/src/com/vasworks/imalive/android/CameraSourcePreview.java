...
import com.vasworks.imalive.android.CustomCameraSource.PictureCallback;
import com.vasworks.imalive.android.CustomCameraSource.ShutterCallback;
...
public class CameraSourcePreview extends ViewGroup {
	...
	private CustomCameraSource mCameraSource;
	...
	public void start(CustomCameraSource cameraSource) throws IOException {
	...
	public void start(CustomCameraSource cameraSource, GraphicOverlay overlay) throws IOException {
		mOverlay = overlay;
		start(cameraSource);
	}
		...
		if (mCameraSource != null) {
			...
			PictureCallback jpeg = new PictureCallback() {
				...
				public void onPictureTaken(byte[] data) {
					...
					FaceDetector detector = new Builder(mContext).setLandmarkType(FaceDetector.ALL_LANDMARKS).setProminentFaceOnly(true).build();
					Frame frame = new Frame.Builder().setBitmap(wholePhoto).build();
