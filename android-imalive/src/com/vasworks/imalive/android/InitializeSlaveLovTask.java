...
public class InitializeSlaveLovTask extends AsyncTask<Void, Void, Object> {
	...
	InitializeSlaveLovTask(Context context, String methodName, HashMap<String, Object> paramsMap, Spinner spinnerView, View progressDialog, Button formButton) {
